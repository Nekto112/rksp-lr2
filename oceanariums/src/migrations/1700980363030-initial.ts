...
export class Initial1700980363030 implements MigrationInterface {
    name = 'Initial1700980363030'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "oceanarium" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "location" character varying NOT NULL, "grade" character varying NOT NULL, CONSTRAINT "PK_bc7372590b3f4397fd1afc32951" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "fishs" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "species" character varying NOT NULL, "habitat" character varying NOT NULL, "location" character varying NOT NULL, CONSTRAINT "UQ_b4edfacf87080d8fe8a360de14f" UNIQUE ("name"), CONSTRAINT "PK_34337a43398c0fae40c971cb9a6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "oceanarium_fish" ADD CONSTRAINT "FK_62959ceeaa87d7abc7717861942" FOREIGN KEY ("fish_id") REFERENCES "fishs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "fishs"`);
